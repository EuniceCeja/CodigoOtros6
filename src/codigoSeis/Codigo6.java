...
public class Codigo6 {// Creamos el metodo main
    ...
    public static void main(String[] args) {
        ...
        opcion = Integer.parseInt(scanner.nextLine());// Falto cerrar un parentesis, al querer leer lo que se escribe en consola no se puede usar console() ya que este metodo devuelve una valor nulo, por lo que utilizaremos un Scanner para leer el valor que ingrese el usuario
